...
// Menu: Main
// upper: none
MENU_OBJ(spMenuMain, "Main", 2, NULL)
MENU_ITEM_SUBMENU(&spMenuAutoConnect)
...
MENU_OBJ(spMenuAutoConnect, "Set AutoConnect", 3, &spMenuMain)
  MENU_ITEM_ACTION("Disable", SimplePeripheral_doAutoConnect)
  MENU_ITEM_ACTION("Group A", SimplePeripheral_doAutoConnect)
  MENU_ITEM_ACTION("Group B", SimplePeripheral_doAutoConnect)
MENU_OBJ_END
